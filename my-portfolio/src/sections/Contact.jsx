...
export default function Contact() {
  return (
    <section id="contact" className="py-16 sm:py-24 px-4 sm:px-6 max-w-2xl mx-auto text-center">
      ...
      <motion.p
        ...
        className="text-[#94a3b8] text-base sm:text-lg leading-relaxed mb-3"
      >
      ...
      <motion.p
        ...
        className="text-[#64748b] text-sm sm:text-base mb-10 italic"
      >
      ...
      <motion.a
        ...
        className="inline-block w-full sm:w-auto px-8 py-3 rounded-lg bg-[#6366f1] text-white font-semibold hover:bg-[#4f46e5] transition-colors duration-200 shadow-lg shadow-[#6366f1]/20"
      >
        Say Hello 👋
      </motion.a>
